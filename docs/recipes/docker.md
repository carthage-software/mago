...
| `<version>`       | `ghcr.io/carthage-software/mago:1.20.0` | Pinned to an exact version                       |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.20`   | Tracks the latest patch within a minor version   |
