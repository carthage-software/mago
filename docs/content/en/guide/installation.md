...
Tags include `latest`, exact versions, and progressively looser pins (for example `1.42.0`, `1.42`, `1`). The [Docker recipe](/recipes/docker/) covers CI examples and the limitations to be aware of.
