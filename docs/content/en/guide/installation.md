...
Tags include `latest`, exact versions, and progressively looser pins (for example `1.47.4`, `1.47`, `1`). The [Docker recipe](/recipes/docker/) covers CI examples and the limitations to be aware of.
