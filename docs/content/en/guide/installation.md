...
Tags include `latest`, exact versions, and progressively looser pins (for example `1.45.0`, `1.45`, `1`). The [Docker recipe](/recipes/docker/) covers CI examples and the limitations to be aware of.
