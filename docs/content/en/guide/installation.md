...
Tags include `latest`, exact versions, and progressively looser pins (for example `1.49.0`, `1.49`, `1`). The [Docker recipe](/recipes/docker/) covers CI examples and the limitations to be aware of.
