...
- `https://mago.carthage.software/<version>/schema.json` — pinned to a specific release such as `1.40.2`.
...
| :--- | :--- | :--- | :--- |
| `version` | string | none | Pins the Mago version this project is tested against. Accepts a major (`"1"`), minor (`"1.40"`), or exact (`"1.40.2"`) pin. See [version pinning](#version-pinning). |
...
- **Exact pin** (`version = "1.40.2"`): any drift warns; drift across majors is still fatal.
