+++
title = "Rules"
description = "The full reference of every linter rule, sorted by severity. Click any rule to expand its description, examples, and configuration."
nav_order = 70
nav_section = "Tools"
nav_subsection = "Linter"
+++
Mago's linter ships 190 rules across 9 categories. Click any rule to expand its description, requirements, default configuration, and examples.

<div class="rule-index" role="navigation" aria-label="Rule categories"><a class="rule-index__item" href="#clarity"><span class="rule-index__name">Clarity</span><span class="rule-index__count">22 rules</span><span class="rule-index__blurb">Rules that make intent explicit and reduce reader effort. They flag patterns that are technically valid but obscure what the code is doing.</span></a><a class="rule-index__item" href="#bestpractices"><span class="rule-index__name">Best practices</span><span class="rule-index__count">47 rules</span><span class="rule-index__blurb">Idiomatic PHP patterns and widely-accepted conventions. These rules nudge code toward the way modern PHP is written by people who've shipped a lot of it.</span></a><a class="rule-index__item" href="#consistency"><span class="rule-index__name">Consistency</span><span class="rule-index__count">27 rules</span><span class="rule-index__blurb">Stylistic uniformity across a codebase. Pick one way to do a thing, these rules help everyone stick to it.</span></a><a class="rule-index__item" href="#deprecation"><span class="rule-index__name">Deprecation</span><span class="rule-index__count">7 rules</span><span class="rule-index__blurb">PHP features and APIs that have been deprecated upstream and will eventually be removed. Migrate before they break.</span></a><a class="rule-index__item" href="#maintainability"><span class="rule-index__name">Maintainability</span><span class="rule-index__count">11 rules</span><span class="rule-index__blurb">Code that is hard to keep alive over time, too complex, too tangled, too fragile. These rules surface the cost early.</span></a><a class="rule-index__item" href="#redundancy"><span class="rule-index__name">Redundancy</span><span class="rule-index__count">31 rules</span><span class="rule-index__blurb">Dead code, unused values, and constructs that have no observable effect. Trimming them keeps the codebase honest.</span></a><a class="rule-index__item" href="#security"><span class="rule-index__name">Security</span><span class="rule-index__count">15 rules</span><span class="rule-index__blurb">Rules that flag security vulnerabilities, injection vectors, unsafe deserialisation, untrusted input flowing into dangerous sinks.</span></a><a class="rule-index__item" href="#safety"><span class="rule-index__name">Safety</span><span class="rule-index__count">9 rules</span><span class="rule-index__blurb">Patterns that compile but blow up at runtime. These rules catch the foot-guns before users do.</span></a><a class="rule-index__item" href="#correctness"><span class="rule-index__name">Correctness</span><span class="rule-index__count">21 rules</span><span class="rule-index__blurb">Bugs and logic errors. Rules in this category catch code that does something the author probably did not intend.</span></a></div>
...
Rules that make intent explicit and reduce reader effort. They flag patterns that are technically valid but obscure what the code is doing.

<div class="rule-list">

<details class="rule" name="rule" id="no-empty">
<summary><code class="rule__code">no-empty</code><a class="rule__anchor" href="#no-empty" aria-label="Permalink to no-empty">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">explicit-octal</code><a class="rule__anchor" href="#explicit-octal" aria-label="Permalink to explicit-octal">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">instanceof-stringable</code><a class="rule__anchor" href="#instanceof-stringable" aria-label="Permalink to instanceof-stringable">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<blockquote class="rule-requirement">This rule requires PHP version <code>8.0.0</code> or newer.</blockquote>
...
<summary><code class="rule__code">literal-named-argument</code><a class="rule__anchor" href="#literal-named-argument" aria-label="Permalink to literal-named-argument">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-hash-emoji</code><a class="rule__anchor" href="#no-hash-emoji" aria-label="Permalink to no-hash-emoji">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-isset</code><a class="rule__anchor" href="#no-isset" aria-label="Permalink to no-isset">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-multi-assignments</code><a class="rule__anchor" href="#no-multi-assignments" aria-label="Permalink to no-multi-assignments">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-nested-ternary</code><a class="rule__anchor" href="#no-nested-ternary" aria-label="Permalink to no-nested-ternary">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-shorthand-ternary</code><a class="rule__anchor" href="#no-shorthand-ternary" aria-label="Permalink to no-shorthand-ternary">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-variable-variable</code><a class="rule__anchor" href="#no-variable-variable" aria-label="Permalink to no-variable-variable">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">readable-literal</code><a class="rule__anchor" href="#readable-literal" aria-label="Permalink to readable-literal">¶</a><span class="rule__level rule__level--warning">warning</span></summary>

<div class="rule__body">

Enforces using underscore separators in numeric literals for improved readability.

<blockquote class="rule-requirement">This rule requires PHP version <code>7.4.0</code> or newer.</blockquote>
...
<summary><code class="rule__code">str-contains</code><a class="rule__anchor" href="#str-contains" aria-label="Permalink to str-contains">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">str-starts-with</code><a class="rule__anchor" href="#str-starts-with" aria-label="Permalink to str-starts-with">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">tagged-fixme</code><a class="rule__anchor" href="#tagged-fixme" aria-label="Permalink to tagged-fixme">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">tagged-todo</code><a class="rule__anchor" href="#tagged-todo" aria-label="Permalink to tagged-todo">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">use-dedicated-expectation</code><a class="rule__anchor" href="#use-dedicated-expectation" aria-label="Permalink to use-dedicated-expectation">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<blockquote class="rule-requirement">This rule requires the <a href="#integration-pest"><code>Pest</code></a> integration to be enabled.</blockquote>
...
<summary><code class="rule__code">use-simpler-expectation</code><a class="rule__anchor" href="#use-simpler-expectation" aria-label="Permalink to use-simpler-expectation">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">use-specific-expectations</code><a class="rule__anchor" href="#use-specific-expectations" aria-label="Permalink to use-specific-expectations">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">valid-docblock</code><a class="rule__anchor" href="#valid-docblock" aria-label="Permalink to valid-docblock">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">missing-docs</code><a class="rule__anchor" href="#missing-docs" aria-label="Permalink to missing-docs">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-negated-ternary</code><a class="rule__anchor" href="#no-negated-ternary" aria-label="Permalink to no-negated-ternary">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-short-bool-cast</code><a class="rule__anchor" href="#no-short-bool-cast" aria-label="Permalink to no-short-bool-cast">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
Idiomatic PHP patterns and widely-accepted conventions. These rules nudge code toward the way modern PHP is written by people who've shipped a lot of it.

<div class="rule-list">

<details class="rule" name="rule" id="final-controller">
<summary><code class="rule__code">final-controller</code><a class="rule__anchor" href="#final-controller" aria-label="Permalink to final-controller">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<blockquote class="rule-requirement">This rule requires one of the following integration sets to be enabled: <a href="#integration-symfony"><code>Symfony</code></a>; or <a href="#integration-laravel"><code>Laravel</code></a>; or <a href="#integration-tempest"><code>Tempest</code></a>; or <a href="#integration-spiral"><code>Spiral</code></a>; or <a href="#integration-cakephp"><code>CakePHP</code></a>; or <a href="#integration-yii"><code>Yii</code></a>.</blockquote>
...
<summary><code class="rule__code">no-inline</code><a class="rule__anchor" href="#no-inline" aria-label="Permalink to no-inline">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">psl-output</code><a class="rule__anchor" href="#psl-output" aria-label="Permalink to psl-output">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<blockquote class="rule-requirement">This rule requires the <a href="#integration-psl"><code>Psl</code></a> integration to be enabled.</blockquote>
...
<summary><code class="rule__code">combine-consecutive-issets</code><a class="rule__anchor" href="#combine-consecutive-issets" aria-label="Permalink to combine-consecutive-issets">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">loop-does-not-iterate</code><a class="rule__anchor" href="#loop-does-not-iterate" aria-label="Permalink to loop-does-not-iterate">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">middleware-in-routes</code><a class="rule__anchor" href="#middleware-in-routes" aria-label="Permalink to middleware-in-routes">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<blockquote class="rule-requirement">This rule requires the <a href="#integration-laravel"><code>Laravel</code></a> integration to be enabled.</blockquote>
...
<summary><code class="rule__code">no-array-accumulation-in-loop</code><a class="rule__anchor" href="#no-array-accumulation-in-loop" aria-label="Permalink to no-array-accumulation-in-loop">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-direct-db-query</code><a class="rule__anchor" href="#no-direct-db-query" aria-label="Permalink to no-direct-db-query">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<blockquote class="rule-requirement">This rule requires the <a href="#integration-wordpress"><code>WordPress</code></a> integration to be enabled.</blockquote>
...
<summary><code class="rule__code">no-ini-set</code><a class="rule__anchor" href="#no-ini-set" aria-label="Permalink to no-ini-set">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-literal-namespace-string</code><a class="rule__anchor" href="#no-literal-namespace-string" aria-label="Permalink to no-literal-namespace-string">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-parameter-shadowing</code><a class="rule__anchor" href="#no-parameter-shadowing" aria-label="Permalink to no-parameter-shadowing">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-side-effects-with-declarations</code><a class="rule__anchor" href="#no-side-effects-with-declarations" aria-label="Permalink to no-side-effects-with-declarations">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-sprintf-concat</code><a class="rule__anchor" href="#no-sprintf-concat" aria-label="Permalink to no-sprintf-concat">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">prefer-anonymous-migration</code><a class="rule__anchor" href="#prefer-anonymous-migration" aria-label="Permalink to prefer-anonymous-migration">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">prefer-explode-over-preg-split</code><a class="rule__anchor" href="#prefer-explode-over-preg-split" aria-label="Permalink to prefer-explode-over-preg-split">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">prefer-first-class-callable</code><a class="rule__anchor" href="#prefer-first-class-callable" aria-label="Permalink to prefer-first-class-callable">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">prefer-test-attribute</code><a class="rule__anchor" href="#prefer-test-attribute" aria-label="Permalink to prefer-test-attribute">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<blockquote class="rule-requirement">This rule requires the <a href="#integration-phpunit"><code>PHPUnit</code></a> integration to be enabled.</blockquote>
...
<summary><code class="rule__code">psl-array-functions</code><a class="rule__anchor" href="#psl-array-functions" aria-label="Permalink to psl-array-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">psl-data-structures</code><a class="rule__anchor" href="#psl-data-structures" aria-label="Permalink to psl-data-structures">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">psl-datetime</code><a class="rule__anchor" href="#psl-datetime" aria-label="Permalink to psl-datetime">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">psl-math-functions</code><a class="rule__anchor" href="#psl-math-functions" aria-label="Permalink to psl-math-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">psl-randomness-functions</code><a class="rule__anchor" href="#psl-randomness-functions" aria-label="Permalink to psl-randomness-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">psl-regex-functions</code><a class="rule__anchor" href="#psl-regex-functions" aria-label="Permalink to psl-regex-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">psl-sleep-functions</code><a class="rule__anchor" href="#psl-sleep-functions" aria-label="Permalink to psl-sleep-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">psl-string-functions</code><a class="rule__anchor" href="#psl-string-functions" aria-label="Permalink to psl-string-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">require-namespace</code><a class="rule__anchor" href="#require-namespace" aria-label="Permalink to require-namespace">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">single-class-per-file</code><a class="rule__anchor" href="#single-class-per-file" aria-label="Permalink to single-class-per-file">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">use-wp-functions</code><a class="rule__anchor" href="#use-wp-functions" aria-label="Permalink to use-wp-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-implicit-model-query</code><a class="rule__anchor" href="#no-implicit-model-query" aria-label="Permalink to no-implicit-model-query">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">prefer-array-validation-rules</code><a class="rule__anchor" href="#prefer-array-validation-rules" aria-label="Permalink to prefer-array-validation-rules">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">prefer-casts-method</code><a class="rule__anchor" href="#prefer-casts-method" aria-label="Permalink to prefer-casts-method">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">prefer-dedicated-status-assertion</code><a class="rule__anchor" href="#prefer-dedicated-status-assertion" aria-label="Permalink to prefer-dedicated-status-assertion">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">prefer-fake-helper</code><a class="rule__anchor" href="#prefer-fake-helper" aria-label="Permalink to prefer-fake-helper">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">prefer-interface</code><a class="rule__anchor" href="#prefer-interface" aria-label="Permalink to prefer-interface">¶</a><span class="rule__level rule__level--note">note</span></summary>

<div class="rule__body">

Detects when an implementation class is used instead of the interface.

<blockquote class="rule-requirement">This rule requires the <a href="#integration-symfony"><code>Symfony</code></a> integration to be enabled.</blockquote>
...
<summary><code class="rule__code">prefer-while-loop</code><a class="rule__anchor" href="#prefer-while-loop" aria-label="Permalink to prefer-while-loop">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">prefer-arrow-function</code><a class="rule__anchor" href="#prefer-arrow-function" aria-label="Permalink to prefer-arrow-function">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">prefer-datetimeimmutable-create-from-timestamp</code><a class="rule__anchor" href="#prefer-datetimeimmutable-create-from-timestamp" aria-label="Permalink to prefer-datetimeimmutable-create-from-timestamp">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<blockquote class="rule-requirement">This rule requires PHP version <code>8.4.0</code> or newer.</blockquote>
...
<summary><code class="rule__code">prefer-early-continue</code><a class="rule__anchor" href="#prefer-early-continue" aria-label="Permalink to prefer-early-continue">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">prefer-early-return</code><a class="rule__anchor" href="#prefer-early-return" aria-label="Permalink to prefer-early-return">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">prefer-pre-increment</code><a class="rule__anchor" href="#prefer-pre-increment" aria-label="Permalink to prefer-pre-increment">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">prefer-self-return-type</code><a class="rule__anchor" href="#prefer-self-return-type" aria-label="Permalink to prefer-self-return-type">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">prefer-static-closure</code><a class="rule__anchor" href="#prefer-static-closure" aria-label="Permalink to prefer-static-closure">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">prefer-view-array</code><a class="rule__anchor" href="#prefer-view-array" aria-label="Permalink to prefer-view-array">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">sorted-integer-keys</code><a class="rule__anchor" href="#sorted-integer-keys" aria-label="Permalink to sorted-integer-keys">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">use-compound-assignment</code><a class="rule__anchor" href="#use-compound-assignment" aria-label="Permalink to use-compound-assignment">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">yoda-conditions</code><a class="rule__anchor" href="#yoda-conditions" aria-label="Permalink to yoda-conditions">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
Stylistic uniformity across a codebase. Pick one way to do a thing, these rules help everyone stick to it.

<div class="rule-list">

<details class="rule" name="rule" id="assertion-style">
<summary><code class="rule__code">assertion-style</code><a class="rule__anchor" href="#assertion-style" aria-label="Permalink to assertion-style">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">file-name</code><a class="rule__anchor" href="#file-name" aria-label="Permalink to file-name">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-alternative-syntax</code><a class="rule__anchor" href="#no-alternative-syntax" aria-label="Permalink to no-alternative-syntax">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-hash-comment</code><a class="rule__anchor" href="#no-hash-comment" aria-label="Permalink to no-hash-comment">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">array-style</code><a class="rule__anchor" href="#array-style" aria-label="Permalink to array-style">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">block-statement</code><a class="rule__anchor" href="#block-statement" aria-label="Permalink to block-statement">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">braced-string-interpolation</code><a class="rule__anchor" href="#braced-string-interpolation" aria-label="Permalink to braced-string-interpolation">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">no-alias-function</code><a class="rule__anchor" href="#no-alias-function" aria-label="Permalink to no-alias-function">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">no-php-tag-terminator</code><a class="rule__anchor" href="#no-php-tag-terminator" aria-label="Permalink to no-php-tag-terminator">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">no-trailing-space</code><a class="rule__anchor" href="#no-trailing-space" aria-label="Permalink to no-trailing-space">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">string-style</code><a class="rule__anchor" href="#string-style" aria-label="Permalink to string-style">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">ambiguous-constant-access</code><a class="rule__anchor" href="#ambiguous-constant-access" aria-label="Permalink to ambiguous-constant-access">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">ambiguous-function-call</code><a class="rule__anchor" href="#ambiguous-function-call" aria-label="Permalink to ambiguous-function-call">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">class-name</code><a class="rule__anchor" href="#class-name" aria-label="Permalink to class-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">constant-name</code><a class="rule__anchor" href="#constant-name" aria-label="Permalink to constant-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">enum-name</code><a class="rule__anchor" href="#enum-name" aria-label="Permalink to enum-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">function-name</code><a class="rule__anchor" href="#function-name" aria-label="Permalink to function-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">interface-name</code><a class="rule__anchor" href="#interface-name" aria-label="Permalink to interface-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">lowercase-keyword</code><a class="rule__anchor" href="#lowercase-keyword" aria-label="Permalink to lowercase-keyword">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">lowercase-type-hint</code><a class="rule__anchor" href="#lowercase-type-hint" aria-label="Permalink to lowercase-type-hint">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">method-name</code><a class="rule__anchor" href="#method-name" aria-label="Permalink to method-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-fully-qualified-global-class-like</code><a class="rule__anchor" href="#no-fully-qualified-global-class-like" aria-label="Permalink to no-fully-qualified-global-class-like">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-fully-qualified-global-constant</code><a class="rule__anchor" href="#no-fully-qualified-global-constant" aria-label="Permalink to no-fully-qualified-global-constant">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-fully-qualified-global-function</code><a class="rule__anchor" href="#no-fully-qualified-global-function" aria-label="Permalink to no-fully-qualified-global-function">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">property-name</code><a class="rule__anchor" href="#property-name" aria-label="Permalink to property-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">trait-name</code><a class="rule__anchor" href="#trait-name" aria-label="Permalink to trait-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">variable-name</code><a class="rule__anchor" href="#variable-name" aria-label="Permalink to variable-name">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
PHP features and APIs that have been deprecated upstream and will eventually be removed. Migrate before they break.

<div class="rule-list">

<details class="rule" name="rule" id="deprecated-cast">
<summary><code class="rule__code">deprecated-cast</code><a class="rule__anchor" href="#deprecated-cast" aria-label="Permalink to deprecated-cast">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<blockquote class="rule-requirement">This rule requires PHP version <code>8.5.0</code> or newer.</blockquote>
...
<summary><code class="rule__code">deprecated-shell-execute-string</code><a class="rule__anchor" href="#deprecated-shell-execute-string" aria-label="Permalink to deprecated-shell-execute-string">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">deprecated-switch-semicolon</code><a class="rule__anchor" href="#deprecated-switch-semicolon" aria-label="Permalink to deprecated-switch-semicolon">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">explicit-nullable-param</code><a class="rule__anchor" href="#explicit-nullable-param" aria-label="Permalink to explicit-nullable-param">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-underscore-class</code><a class="rule__anchor" href="#no-underscore-class" aria-label="Permalink to no-underscore-class">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-void-reference-return</code><a class="rule__anchor" href="#no-void-reference-return" aria-label="Permalink to no-void-reference-return">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<blockquote class="rule-requirement">This rule requires PHP version <code>8.2.0</code> or newer.</blockquote>
...
<summary><code class="rule__code">optional-param-order</code><a class="rule__anchor" href="#optional-param-order" aria-label="Permalink to optional-param-order">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
Code that is hard to keep alive over time, too complex, too tangled, too fragile. These rules surface the cost early.

<div class="rule-list">

<details class="rule" name="rule" id="cyclomatic-complexity">
<summary><code class="rule__code">cyclomatic-complexity</code><a class="rule__anchor" href="#cyclomatic-complexity" aria-label="Permalink to cyclomatic-complexity">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">excessive-parameter-list</code><a class="rule__anchor" href="#excessive-parameter-list" aria-label="Permalink to excessive-parameter-list">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">kan-defect</code><a class="rule__anchor" href="#kan-defect" aria-label="Permalink to kan-defect">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">too-many-enum-cases</code><a class="rule__anchor" href="#too-many-enum-cases" aria-label="Permalink to too-many-enum-cases">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">too-many-methods</code><a class="rule__anchor" href="#too-many-methods" aria-label="Permalink to too-many-methods">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">too-many-properties</code><a class="rule__anchor" href="#too-many-properties" aria-label="Permalink to too-many-properties">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">excessive-nesting</code><a class="rule__anchor" href="#excessive-nesting" aria-label="Permalink to excessive-nesting">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">halstead</code><a class="rule__anchor" href="#halstead" aria-label="Permalink to halstead">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-goto</code><a class="rule__anchor" href="#no-goto" aria-label="Permalink to no-goto">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">no-boolean-flag-parameter</code><a class="rule__anchor" href="#no-boolean-flag-parameter" aria-label="Permalink to no-boolean-flag-parameter">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-else-clause</code><a class="rule__anchor" href="#no-else-clause" aria-label="Permalink to no-else-clause">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
Dead code, unused values, and constructs that have no observable effect. Trimming them keeps the codebase honest.

<div class="rule-list">

<details class="rule" name="rule" id="inline-variable-return">
<summary><code class="rule__code">inline-variable-return</code><a class="rule__anchor" href="#inline-variable-return" aria-label="Permalink to inline-variable-return">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-iterator-to-array-in-foreach</code><a class="rule__anchor" href="#no-iterator-to-array-in-foreach" aria-label="Permalink to no-iterator-to-array-in-foreach">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-redundant-literal-return</code><a class="rule__anchor" href="#no-redundant-literal-return" aria-label="Permalink to no-redundant-literal-return">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-redundant-use</code><a class="rule__anchor" href="#no-redundant-use" aria-label="Permalink to no-redundant-use">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-self-assignment</code><a class="rule__anchor" href="#no-self-assignment" aria-label="Permalink to no-self-assignment">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-duplicate-match-arm</code><a class="rule__anchor" href="#no-duplicate-match-arm" aria-label="Permalink to no-duplicate-match-arm">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">no-empty-comment</code><a class="rule__anchor" href="#no-empty-comment" aria-label="Permalink to no-empty-comment">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">no-empty-loop</code><a class="rule__anchor" href="#no-empty-loop" aria-label="Permalink to no-empty-loop">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">no-is-null</code><a class="rule__anchor" href="#no-is-null" aria-label="Permalink to no-is-null">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
<summary><code class="rule__code">constant-condition</code><a class="rule__anchor" href="#constant-condition" aria-label="Permalink to constant-condition">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-closing-tag</code><a class="rule__anchor" href="#no-closing-tag" aria-label="Permalink to no-closing-tag">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-noop</code><a class="rule__anchor" href="#no-noop" aria-label="Permalink to no-noop">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-null-property-init</code><a class="rule__anchor" href="#no-null-property-init" aria-label="Permalink to no-null-property-init">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-protected-in-final</code><a class="rule__anchor" href="#no-protected-in-final" aria-label="Permalink to no-protected-in-final">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-binary-string-prefix</code><a class="rule__anchor" href="#no-redundant-binary-string-prefix" aria-label="Permalink to no-redundant-binary-string-prefix">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-block</code><a class="rule__anchor" href="#no-redundant-block" aria-label="Permalink to no-redundant-block">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-continue</code><a class="rule__anchor" href="#no-redundant-continue" aria-label="Permalink to no-redundant-continue">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-else</code><a class="rule__anchor" href="#no-redundant-else" aria-label="Permalink to no-redundant-else">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-file</code><a class="rule__anchor" href="#no-redundant-file" aria-label="Permalink to no-redundant-file">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-final</code><a class="rule__anchor" href="#no-redundant-final" aria-label="Permalink to no-redundant-final">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-isset</code><a class="rule__anchor" href="#no-redundant-isset" aria-label="Permalink to no-redundant-isset">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-label</code><a class="rule__anchor" href="#no-redundant-label" aria-label="Permalink to no-redundant-label">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-math</code><a class="rule__anchor" href="#no-redundant-math" aria-label="Permalink to no-redundant-math">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-method-override</code><a class="rule__anchor" href="#no-redundant-method-override" aria-label="Permalink to no-redundant-method-override">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-nullsafe</code><a class="rule__anchor" href="#no-redundant-nullsafe" aria-label="Permalink to no-redundant-nullsafe">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-parentheses</code><a class="rule__anchor" href="#no-redundant-parentheses" aria-label="Permalink to no-redundant-parentheses">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-readonly</code><a class="rule__anchor" href="#no-redundant-readonly" aria-label="Permalink to no-redundant-readonly">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-string-concat</code><a class="rule__anchor" href="#no-redundant-string-concat" aria-label="Permalink to no-redundant-string-concat">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-write-visibility</code><a class="rule__anchor" href="#no-redundant-write-visibility" aria-label="Permalink to no-redundant-write-visibility">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">no-redundant-yield-from</code><a class="rule__anchor" href="#no-redundant-yield-from" aria-label="Permalink to no-redundant-yield-from">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
<summary><code class="rule__code">redundant-static</code><a class="rule__anchor" href="#redundant-static" aria-label="Permalink to redundant-static">¶</a><span class="rule__level rule__level--help">help</span></summary>
...
Rules that flag security vulnerabilities, injection vectors, unsafe deserialisation, untrusted input flowing into dangerous sinks.

<div class="rule-list">

<details class="rule" name="rule" id="no-db-schema-change">
<summary><code class="rule__code">no-db-schema-change</code><a class="rule__anchor" href="#no-db-schema-change" aria-label="Permalink to no-db-schema-change">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-insecure-comparison</code><a class="rule__anchor" href="#no-insecure-comparison" aria-label="Permalink to no-insecure-comparison">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-literal-password</code><a class="rule__anchor" href="#no-literal-password" aria-label="Permalink to no-literal-password">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-unescaped-output</code><a class="rule__anchor" href="#no-unescaped-output" aria-label="Permalink to no-unescaped-output">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">prepared-sql</code><a class="rule__anchor" href="#prepared-sql" aria-label="Permalink to prepared-sql">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">sensitive-parameter</code><a class="rule__anchor" href="#sensitive-parameter" aria-label="Permalink to sensitive-parameter">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">tainted-data-to-sink</code><a class="rule__anchor" href="#tainted-data-to-sink" aria-label="Permalink to tainted-data-to-sink">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">validated-sanitized-input</code><a class="rule__anchor" href="#validated-sanitized-input" aria-label="Permalink to validated-sanitized-input">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">disallowed-functions</code><a class="rule__anchor" href="#disallowed-functions" aria-label="Permalink to disallowed-functions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">disallowed-type-instantiation</code><a class="rule__anchor" href="#disallowed-type-instantiation" aria-label="Permalink to disallowed-type-instantiation">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-roles-as-capabilities</code><a class="rule__anchor" href="#no-roles-as-capabilities" aria-label="Permalink to no-roles-as-capabilities">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-short-opening-tag</code><a class="rule__anchor" href="#no-short-opening-tag" aria-label="Permalink to no-short-opening-tag">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">nonce-verification</code><a class="rule__anchor" href="#nonce-verification" aria-label="Permalink to nonce-verification">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">require-preg-quote-delimiter</code><a class="rule__anchor" href="#require-preg-quote-delimiter" aria-label="Permalink to require-preg-quote-delimiter">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-debug-symbols</code><a class="rule__anchor" href="#no-debug-symbols" aria-label="Permalink to no-debug-symbols">¶</a><span class="rule__level rule__level--note">note</span></summary>
...
Patterns that compile but blow up at runtime. These rules catch the foot-guns before users do.

<div class="rule-list">

<details class="rule" name="rule" id="no-error-control-operator">
<summary><code class="rule__code">no-error-control-operator</code><a class="rule__anchor" href="#no-error-control-operator" aria-label="Permalink to no-error-control-operator">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-eval</code><a class="rule__anchor" href="#no-eval" aria-label="Permalink to no-eval">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-ffi</code><a class="rule__anchor" href="#no-ffi" aria-label="Permalink to no-ffi">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-global</code><a class="rule__anchor" href="#no-global" aria-label="Permalink to no-global">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-request-variable</code><a class="rule__anchor" href="#no-request-variable" aria-label="Permalink to no-request-variable">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-shell-execute-string</code><a class="rule__anchor" href="#no-shell-execute-string" aria-label="Permalink to no-shell-execute-string">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-unsafe-finally</code><a class="rule__anchor" href="#no-unsafe-finally" aria-label="Permalink to no-unsafe-finally">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-request-all</code><a class="rule__anchor" href="#no-request-all" aria-label="Permalink to no-request-all">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-service-state-mutation</code><a class="rule__anchor" href="#no-service-state-mutation" aria-label="Permalink to no-service-state-mutation">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
Bugs and logic errors. Rules in this category catch code that does something the author probably did not intend.

<div class="rule-list">

<details class="rule" name="rule" id="no-missing-format-argument">
<summary><code class="rule__code">no-missing-format-argument</code><a class="rule__anchor" href="#no-missing-format-argument" aria-label="Permalink to no-missing-format-argument">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">no-only</code><a class="rule__anchor" href="#no-only" aria-label="Permalink to no-only">¶</a><span class="rule__level rule__level--error">error</span></summary>
...
<summary><code class="rule__code">assert-description</code><a class="rule__anchor" href="#assert-description" aria-label="Permalink to assert-description">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">identity-comparison</code><a class="rule__anchor" href="#identity-comparison" aria-label="Permalink to identity-comparison">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">ineffective-format-ignore-next</code><a class="rule__anchor" href="#ineffective-format-ignore-next" aria-label="Permalink to ineffective-format-ignore-next">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">ineffective-format-ignore-region</code><a class="rule__anchor" href="#ineffective-format-ignore-region" aria-label="Permalink to ineffective-format-ignore-region">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-assign-in-argument</code><a class="rule__anchor" href="#no-assign-in-argument" aria-label="Permalink to no-assign-in-argument">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-assign-in-condition</code><a class="rule__anchor" href="#no-assign-in-condition" aria-label="Permalink to no-assign-in-condition">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-dead-store</code><a class="rule__anchor" href="#no-dead-store" aria-label="Permalink to no-dead-store">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-empty-catch-clause</code><a class="rule__anchor" href="#no-empty-catch-clause" aria-label="Permalink to no-empty-catch-clause">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-redundant-variable</code><a class="rule__anchor" href="#no-redundant-variable" aria-label="Permalink to no-redundant-variable">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-unused-closure-capture</code><a class="rule__anchor" href="#no-unused-closure-capture" aria-label="Permalink to no-unused-closure-capture">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-unused-global</code><a class="rule__anchor" href="#no-unused-global" aria-label="Permalink to no-unused-global">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">no-unused-static</code><a class="rule__anchor" href="#no-unused-static" aria-label="Permalink to no-unused-static">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">strict-assertions</code><a class="rule__anchor" href="#strict-assertions" aria-label="Permalink to strict-assertions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">strict-behavior</code><a class="rule__anchor" href="#strict-behavior" aria-label="Permalink to strict-behavior">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<blockquote class="rule-requirement">This rule requires PHP version <code>7.0.0</code> or newer.</blockquote>
...
<summary><code class="rule__code">strict-types</code><a class="rule__anchor" href="#strict-types" aria-label="Permalink to strict-types">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">suspicious-explode-arguments</code><a class="rule__anchor" href="#suspicious-explode-arguments" aria-label="Permalink to suspicious-explode-arguments">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">switch-continue-to-break</code><a class="rule__anchor" href="#switch-continue-to-break" aria-label="Permalink to switch-continue-to-break">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">use-specific-assertions</code><a class="rule__anchor" href="#use-specific-assertions" aria-label="Permalink to use-specific-assertions">¶</a><span class="rule__level rule__level--warning">warning</span></summary>
...
<summary><code class="rule__code">invalid-open-tag</code><a class="rule__anchor" href="#invalid-open-tag" aria-label="Permalink to invalid-open-tag">¶</a><span class="rule__level rule__level--note">note</span></summary>
