...
| `<version>` | `ghcr.io/carthage-software/mago:1.47.5` | Pinned to an exact version. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.47` | Tracks the latest patch within a minor version. |
