...
| `<version>` | `ghcr.io/carthage-software/mago:1.41.0` | Pinned to an exact version. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.41` | Tracks the latest patch within a minor version. |
