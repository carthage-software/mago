...
| `<version>` | `ghcr.io/carthage-software/mago:1.42.0` | Pinned to an exact version. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.42` | Tracks the latest patch within a minor version. |
