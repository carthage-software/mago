...
| `<version>` | `ghcr.io/carthage-software/mago:1.27.1` | Pinned to an exact version. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.27` | Tracks the latest patch within a minor version. |
