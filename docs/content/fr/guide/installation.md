...
```sh
curl --proto '=https' --tlsv1.2 -sSf https://carthage.software/mago.sh | bash -s -- --version=1.47.6
```
...
Les tags incluent `latest`, des versions exactes et des épinglages progressivement plus larges (par exemple `1.47.6`, `1.47`, `1`). La [recette Docker](/recipes/docker/) couvre les exemples CI et les limitations à connaître.
...
```sh
composer require --dev "carthage-software/mago:^1.47.6"
```
