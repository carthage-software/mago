...
Les tags incluent `latest`, des versions exactes et des épinglages progressivement plus larges (par exemple `1.30.0`, `1.30`, `1`). La [recette Docker](/recipes/docker/) couvre les exemples CI et les limitations à connaître.
