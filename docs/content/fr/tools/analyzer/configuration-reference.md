...
| `symfony` | `symfony-container` | désactivé | Symfony : ids de service en chaîne dans `get('...')` résolus via le XML du conteneur compilé (requiert `symfony-container-xml-path`). |
