...
| `<version>` | `ghcr.io/carthage-software/mago:1.45.0` | Épinglé à une version exacte. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.45` | Suit le dernier patch d'une version mineure. |
