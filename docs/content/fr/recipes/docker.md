...
| `<version>` | `ghcr.io/carthage-software/mago:1.27.0` | Épinglé à une version exacte. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.27` | Suit le dernier patch d'une version mineure. |
