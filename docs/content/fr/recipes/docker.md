...
| `<version>` | `ghcr.io/carthage-software/mago:1.29.0` | Épinglé à une version exacte. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.29` | Suit le dernier patch d'une version mineure. |
