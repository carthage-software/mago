...
| `<version>` | `ghcr.io/carthage-software/mago:1.47.2` | Épinglé à une version exacte. |
| `<major>.<minor>` | `ghcr.io/carthage-software/mago:1.47` | Suit le dernier patch d'une version mineure. |
