...
function error(): void
{
    (new Example())->foo();
    Example::bar();
    (new ExampleWithBothButStaticOnly())->bar();
    (new ExampleWithBoth())->bar();
}

function warn(): void
{
    (new ExampleWithMagicMethods())->foo();
    ExampleWithMagicMethods::bar();
    (new ExampleWithMagicTags())->foo();
    ExampleWithMagicTags::bar();
}
