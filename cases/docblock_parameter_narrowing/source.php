...
/** @param int $x */
function narrow_scalar_union_to_int(int|string $x): void
{
    echo $x;
}

/** @param string $x */
function narrow_scalar_union_to_string(int|string $x): void
{
    echo $x;
}

/** @param int $x */
function narrow_triple_union_to_int(int|string|float $x): void
{
    echo $x;
}

/** @param array<string, mixed> $o */
function narrow_int_string_array_to_array(int|string|array $o): int
{
    return mt_rand();
}

/** @param int $x */
function narrow_int_or_false_to_int(int|false $x): void
{
    echo $x;
}

/** @param string $x */
function narrow_string_or_false_to_string(string|false $x): void
{
    echo $x;
}

/** @param Foo $x */
function narrow_object_union_to_single(Foo|Bar $x): void
{
    echo get_class($x);
}
...
{
    /** @param int $x */
    public function method_narrow_union(int|string $x): void
    {
        echo $x;
    }

    /** @param int $x */
    public static function static_narrow_union(int|string $x): void
    {
        echo $x;
    }
}
...
$closure_narrowing =
    /** @param int $x */
    static function (int|string $x): void {
        echo $x;
    };
...
function refine_nullable_array(?array $x): void
{
    if ($x !== null) {
        foreach ($x as $v) {
            echo $v;
