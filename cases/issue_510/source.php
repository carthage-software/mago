...
function maybeUseDateAndTime(?Temporal $date, ?Temporal $time): void
{
    match (true) {
...
function maybeUseDateAndTimeUsingIf(?Temporal $date, ?Temporal $time): void
{
...
/**
 */
function maybeUseDateAndTimeNonExhaustive(?Temporal $date, ?Temporal $time): void
{
    match (true) {
        null !== $date && null !== $time => useDateAndTime($date, $time),
        null !== $date => useDate($date),
...
function maybeUseDateAndTimeNonExhaustiveUsingIf(?Temporal $date, ?Temporal $time): void
{
    if (null !== $date && null !== $time) {
        useDateAndTime($date, $time);
    } elseif (null !== $date) {
