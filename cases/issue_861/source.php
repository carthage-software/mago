...
/**
 * @template TParent of object|null
 */
...
echo (new ParentNode())->thisChild()->doChildThing()->end()->doParentThing();

echo (new ParentNode())->staticChild()->doChildThing()->end()->doParentThing();

echo (new ParentNode())->typeChild()->doChildThing()->end()->doParentThing();
