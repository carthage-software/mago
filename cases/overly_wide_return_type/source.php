...
function pms_callback_wide(): string|false
{
    return 'test';
}
...
function scalar_union_drops_array(): int|string|array
{
    if (mt_rand(0, 1)) {
        return 1;
    }
...
function int_or_false_always_int(): int|false
{
    if (mt_rand(0, 1)) {
        return 1;
    }
...
$wide_closure = static function (): int|false {
    return 42;
};
