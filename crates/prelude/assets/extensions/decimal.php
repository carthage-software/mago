...
final class Decimal implements \JsonSerializable
{
    ...
    /* halfway ties towards zero */
    public const ROUND_HALF_DOWN = 0;

    /* halfway ties to nearest even number */
    public const ROUND_HALF_EVEN = 0;

    /* halfway ties to nearest odd number */
     ...
     * @throws \DomainException is the type is supported but the value could not be converted to decimal.
     */
     ...
     * Sum
     *
     * The precision of the result will be the max of all precisions that
     * were encountered during the calculation. The given precision should therefore
     ...
     *
     * @return Decimal the remainder after dividing the integer value of this decimal by the integer value of the given value
     *
     * @throws \TypeError if the value is not a decimal, string or integer.
     ...
     *
     * @return Decimal the natural logarithm of this decimal (log base e), with the same precision as this decimal.
     */
     ...
     * Exponent
     *
     * @return Decimal the exponent of this decimal, ie. e to the power of this, with the same precision as this decimal.
     */
     ...
     * Base-10 logarithm
     *
     * @return Decimal the base-10 logarithm of this decimal, with the same precision as this decimal.
     */
     ...
     * Square root
     *
     * @return Decimal the square root of this decimal, with the same precision as this decimal.
     */
     ...
     * Round
     *
     * @return Decimal the value of this decimal with the same precision, rounded according to the specified number of decimal places and rounding mode
     *
     ...
     * Parity (integer)
     *
     * @return int 0 if the integer value of this decimal is even, 1 if odd. Special numbers like NAN and INF will return 1.
     */
    ...
    /**
     * @return bool TRUE if this decimal is an integer, ie. does not have significant figures behind the decimal point, otherwise FALSE.
     */
    ...
    /**
     * @return string the value of this decimal formatted to a fixed number of decimal places, optionally with thousands comma-separated, using a given rounding mode.
     */
     ...
     * representation of a decimal, because there is more than one way to represent
     * the same value, and precision is not represented by the value itself.
     * However, it is guaranteed that the string representation of a decimal can be
     * used to construct a new decimal with the exact same value, assuming equal precision.
     * If you want to store a decimal with its precision, you should use serialize and unserialize.
     *
     * @return string the value of this decimal represented exactly, in either
     *                fixed or scientific form, depending on the value.
     */
