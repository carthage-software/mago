 ...
 *     },
 * }
 * @psalm-type ValinorConfig = array{
 *     mapper?: array{
 *         date_formats_supported?: list<scalar|null>,
 *         allowed_exceptions?: list<scalar|null>,
 *     },
 *     cache?: array{
 *         service?: scalar|null, // Id of the Symfony cache service used to improve the mapper performance. // Default: "valinor.cache.filesystem"
 *         env_where_files_are_watched?: list<scalar|null>,
 *     },
 *     console?: array{
 *         mapping_errors_to_output?: int, // Maximum number of detailed mapping errors to be displayed to the console. Set to 0 to disable. // Default: 10
 *     },
 * }
 ...
 *     },
 * }
 * @psalm-type ItbShopwareSdkConfig = array{
 *     shop_url: scalar|null,
 *     shopware_version: "0.0.0.0"|"6.5.5.0"|"6.5.6.0"|"6.5.7.1"|"6.5.8.0"|"6.5.8.3"|"6.5.8.8"|"6.5.8.12"|"6.6.0.0"|"6.6.3.0"|"6.6.4.0"|"6.6.5.0"|"6.6.6.0"|"6.6.7.0", // The Shopware version of the shop. The used entity definitions are based on the given version. Use the next lowest defined version if your version is not listed.
 *     credentials: array{ // The credentials are used with the given grant type to authenticate against the Shopware API.
 *         grant_type: "client_credentials"|"password",
 *         client_id?: scalar|null, // Default: null
 *         client_secret?: scalar|null, // Default: null
 *         username?: scalar|null, // Default: null
 *         password?: scalar|null, // Default: null
 *     },
 *     cache?: scalar|null, // The service ID of the cache that should be used for the Shopware access token. A new token will be requested on every request if no service ID is given. // Default: null
 * }
 ...
 * }
 * @psalm-type Speicher210FunctionalTestConfig = array{
 *     fixture_loader_extend_class?: scalar|null, // Default: "Speicher210\\FunctionalTestBundle\\Test\\Loader\\AbstractLoader"
 * }
 ...
 *     itb_shopware_sdk?: ItbShopwareSdkConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
 ...
 *         speicher210_functional_test?: Speicher210FunctionalTestConfig,
 *     },
 *     "when@prod"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
