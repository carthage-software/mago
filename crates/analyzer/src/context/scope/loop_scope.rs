...
pub struct LoopScope {
    ...
    pub parent_context_variables: BTreeMap<Atom, Rc<TUnion>>,
    pub redefined_loop_variables: AtomMap<TUnion>,
    pub possibly_redefined_loop_variables: AtomMap<TUnion>,
    pub possibly_redefined_loop_parent_variables: AtomMap<Rc<TUnion>>,
    pub possibly_defined_loop_parent_variables: AtomMap<TUnion>,
...
impl LoopScope {
    pub fn new(
        span: Span,
        parent_context_vars: BTreeMap<Atom, Rc<TUnion>>,
