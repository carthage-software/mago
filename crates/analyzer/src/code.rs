...
pub enum IssueCode {
    ...
    InvalidArrayIndex,
    InvalidAssignment,
    InvalidByRefGetHookOnBackedProperty,
...
impl IssueCode {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::InvalidByRefGetHookOnBackedProperty => "invalid-by-ref-get-hook-on-backed-property",
...
impl std::str::FromStr for IssueCode {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "invalid-by-ref-get-hook-on-backed-property" => Ok(Self::InvalidByRefGetHookOnBackedProperty),
