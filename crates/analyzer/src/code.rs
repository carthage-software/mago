...
pub enum IssueCode {
    ...
    MagentoCollectionMockSubclass,
    MagentoCollectionViaFactory,
    MagentoNoSetTemplateInBlock,
    MagentoUseResourceModelDirectly,
    MagentoUseServiceContracts,
    MatchArmAlwaysTrue,
...
impl IssueCode {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::MagentoCollectionMockSubclass => "magento-collection-mock-subclass",
            Self::MagentoCollectionViaFactory => "magento-collection-via-factory",
            Self::MagentoNoSetTemplateInBlock => "magento-no-set-template-in-block",
            Self::MagentoUseResourceModelDirectly => "magento-use-resource-model-directly",
            Self::MagentoUseServiceContracts => "magento-use-service-contracts",
    ...
    pub fn all() -> &'static [IssueCode] {
        &[
            ...
            Self::MagentoCollectionMockSubclass,
            Self::MagentoCollectionViaFactory,
            Self::MagentoNoSetTemplateInBlock,
            Self::MagentoUseResourceModelDirectly,
            Self::MagentoUseServiceContracts,
...
impl std::str::FromStr for IssueCode {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "magento-collection-mock-subclass" => Ok(Self::MagentoCollectionMockSubclass),
            "magento-collection-via-factory" => Ok(Self::MagentoCollectionViaFactory),
            "magento-no-set-template-in-block" => Ok(Self::MagentoNoSetTemplateInBlock),
            "magento-use-resource-model-directly" => Ok(Self::MagentoUseResourceModelDirectly),
            "magento-use-service-contracts" => Ok(Self::MagentoUseServiceContracts),
