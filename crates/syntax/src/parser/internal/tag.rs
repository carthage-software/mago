...
pub fn parse_opening_tag<'arena>(stream: &mut TokenStream<'arena>) -> Result<OpeningTag<'arena>, ParseError> {
...
pub fn parse_closing_tag<'arena>(stream: &mut TokenStream<'arena>) -> Result<ClosingTag, ParseError> {
