...
pub fn parse_property_item<'arena>(stream: &mut TokenStream<'arena>) -> Result<PropertyItem<'arena>, ParseError> {
...
pub fn parse_property_hook<'arena>(stream: &mut TokenStream<'arena>) -> Result<PropertyHook<'arena>, ParseError> {
    Ok(PropertyHook {
