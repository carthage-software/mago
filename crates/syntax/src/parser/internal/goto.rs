...
pub fn parse_goto<'arena>(stream: &mut TokenStream<'arena>) -> Result<Goto<'arena>, ParseError> {
    Ok(Goto {
...
pub fn parse_label<'arena>(stream: &mut TokenStream<'arena>) -> Result<Label<'arena>, ParseError> {
