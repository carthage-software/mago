...
pub fn parse_namespace<'arena>(stream: &mut TokenStream<'arena>) -> Result<Namespace<'arena>, ParseError> {
...
pub fn parse_namespace_body<'arena>(stream: &mut TokenStream<'arena>) -> Result<NamespaceBody<'arena>, ParseError> {
