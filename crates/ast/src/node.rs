...
#[serde(tag = "type", content = "value")]
#[repr(C, u8)]
pub enum Node<'a, 'alloc> {
    Program(&'a Program<'alloc>),
    Access(&'a Access<'alloc>),
    ConstantAccess(&'a ConstantAccess),
    ClassConstantAccess(&'a ClassConstantAccess<'alloc>),
    NullSafePropertyAccess(&'a NullSafePropertyAccess<'alloc>),
    PropertyAccess(&'a PropertyAccess<'alloc>),
    StaticPropertyAccess(&'a StaticPropertyAccess<'alloc>),
    Argument(&'a Argument<'alloc>),
    ArgumentList(&'a ArgumentList<'alloc>),
    NamedArgument(&'a NamedArgument<'alloc>),
    PositionalArgument(&'a PositionalArgument<'alloc>),
    Array(&'a Array<'alloc>),
    ArrayAccess(&'a ArrayAccess<'alloc>),
    ArrayAppend(&'a ArrayAppend<'alloc>),
    ArrayElement(&'a ArrayElement<'alloc>),
    ...
    ValueArrayElement(&'a ValueArrayElement<'alloc>),
    VariadicArrayElement(&'a VariadicArrayElement<'alloc>),
    Attribute(&'a Attribute<'alloc>),
    AttributeList(&'a AttributeList<'alloc>),
    Block(&'a Block<'alloc>),
    Call(&'a Call<'alloc>),
    FunctionCall(&'a FunctionCall<'alloc>),
    MethodCall(&'a MethodCall<'alloc>),
    NullSafeMethodCall(&'a NullSafeMethodCall<'alloc>),
    StaticMethodCall(&'a StaticMethodCall<'alloc>),
    ClassLikeConstant(&'a ClassLikeConstant<'alloc>),
    ClassLikeConstantItem(&'a ClassLikeConstantItem<'alloc>),
    EnumCase(&'a EnumCase<'alloc>),
    EnumCaseBackedItem(&'a EnumCaseBackedItem<'alloc>),
    EnumCaseItem(&'a EnumCaseItem<'alloc>),
    EnumCaseUnitItem(&'a EnumCaseUnitItem),
    Extends(&'a Extends<'alloc>),
    Implements(&'a Implements<'alloc>),
    ClassLikeConstantSelector(&'a ClassLikeConstantSelector<'alloc>),
    ClassLikeMember(&'a ClassLikeMember<'alloc>),
    ClassLikeMemberExpressionSelector(&'a ClassLikeMemberExpressionSelector<'alloc>),
    ClassLikeMemberSelector(&'a ClassLikeMemberSelector<'alloc>),
    Method(&'a Method<'alloc>),
    MethodAbstractBody(&'a MethodAbstractBody),
    MethodBody(&'a MethodBody<'alloc>),
    HookedProperty(&'a HookedProperty<'alloc>),
    PlainProperty(&'a PlainProperty<'alloc>),
    Property(&'a Property<'alloc>),
    PropertyAbstractItem(&'a PropertyAbstractItem),
    PropertyConcreteItem(&'a PropertyConcreteItem<'alloc>),
    PropertyHook(&'a PropertyHook<'alloc>),
    PropertyHookAbstractBody(&'a PropertyHookAbstractBody),
    PropertyHookBody(&'a PropertyHookBody<'alloc>),
    PropertyHookConcreteBody(&'a PropertyHookConcreteBody<'alloc>),
    PropertyHookConcreteExpressionBody(&'a PropertyHookConcreteExpressionBody<'alloc>),
    PropertyHookList(&'a PropertyHookList<'alloc>),
    PropertyItem(&'a PropertyItem<'alloc>),
    TraitUse(&'a TraitUse<'alloc>),
    ...
    TraitUseAdaptation(&'a TraitUseAdaptation<'alloc>),
    TraitUseAliasAdaptation(&'a TraitUseAliasAdaptation),
    TraitUseConcreteSpecification(&'a TraitUseConcreteSpecification<'alloc>),
    TraitUseMethodReference(&'a TraitUseMethodReference),
    TraitUsePrecedenceAdaptation(&'a TraitUsePrecedenceAdaptation<'alloc>),
    TraitUseSpecification(&'a TraitUseSpecification<'alloc>),
    AnonymousClass(&'a AnonymousClass<'alloc>),
    Class(&'a Class<'alloc>),
    Enum(&'a Enum<'alloc>),
    EnumBackingTypeHint(&'a EnumBackingTypeHint<'alloc>),
    Interface(&'a Interface<'alloc>),
    Trait(&'a Trait<'alloc>),
    Clone(&'a Clone<'alloc>),
    ClosureCreation(&'a ClosureCreation<'alloc>),
    FunctionClosureCreation(&'a FunctionClosureCreation<'alloc>),
    MethodClosureCreation(&'a MethodClosureCreation<'alloc>),
    StaticMethodClosureCreation(&'a StaticMethodClosureCreation<'alloc>),
    Constant(&'a Constant<'alloc>),
    ConstantItem(&'a ConstantItem<'alloc>),
    Construct(&'a Construct<'alloc>),
    DieConstruct(&'a DieConstruct<'alloc>),
    EmptyConstruct(&'a EmptyConstruct<'alloc>),
    EvalConstruct(&'a EvalConstruct<'alloc>),
    ExitConstruct(&'a ExitConstruct<'alloc>),
    IncludeConstruct(&'a IncludeConstruct<'alloc>),
    IncludeOnceConstruct(&'a IncludeOnceConstruct<'alloc>),
    IssetConstruct(&'a IssetConstruct<'alloc>),
    PrintConstruct(&'a PrintConstruct<'alloc>),
    RequireConstruct(&'a RequireConstruct<'alloc>),
    RequireOnceConstruct(&'a RequireOnceConstruct<'alloc>),
    If(&'a If<'alloc>),
    IfBody(&'a IfBody<'alloc>),
    IfColonDelimitedBody(&'a IfColonDelimitedBody<'alloc>),
    IfColonDelimitedBodyElseClause(&'a IfColonDelimitedBodyElseClause<'alloc>),
    IfColonDelimitedBodyElseIfClause(&'a IfColonDelimitedBodyElseIfClause<'alloc>),
    IfStatementBody(&'a IfStatementBody<'alloc>),
    IfStatementBodyElseClause(&'a IfStatementBodyElseClause<'alloc>),
    IfStatementBodyElseIfClause(&'a IfStatementBodyElseIfClause<'alloc>),
    Match(&'a Match<'alloc>),
    MatchArm(&'a MatchArm<'alloc>),
    MatchDefaultArm(&'a MatchDefaultArm<'alloc>),
    MatchExpressionArm(&'a MatchExpressionArm<'alloc>),
    Switch(&'a Switch<'alloc>),
    SwitchBody(&'a SwitchBody<'alloc>),
    SwitchBraceDelimitedBody(&'a SwitchBraceDelimitedBody<'alloc>),
    SwitchCase(&'a SwitchCase<'alloc>),
    SwitchCaseSeparator(&'a SwitchCaseSeparator),
    SwitchColonDelimitedBody(&'a SwitchColonDelimitedBody<'alloc>),
    SwitchDefaultCase(&'a SwitchDefaultCase<'alloc>),
    SwitchExpressionCase(&'a SwitchExpressionCase<'alloc>),
    Declare(&'a Declare<'alloc>),
    DeclareBody(&'a DeclareBody<'alloc>),
    DeclareColonDelimitedBody(&'a DeclareColonDelimitedBody<'alloc>),
    DeclareItem(&'a DeclareItem<'alloc>),
    Echo(&'a Echo<'alloc>),
    Expression(&'a Expression<'alloc>),
    Binary(&'a Binary<'alloc>),
    BinaryOperator(&'a BinaryOperator),
    UnaryPrefix(&'a UnaryPrefix<'alloc>),
    UnaryPrefixOperator(&'a UnaryPrefixOperator),
    UnaryPostfix(&'a UnaryPostfix<'alloc>),
    UnaryPostfixOperator(&'a UnaryPostfixOperator),
    Parenthesized(&'a Parenthesized<'alloc>),
    ArrowFunction(&'a ArrowFunction<'alloc>),
    Closure(&'a Closure<'alloc>),
    ClosureUseClause(&'a ClosureUseClause<'alloc>),
    ClosureUseClauseVariable(&'a ClosureUseClauseVariable),
    Function(&'a Function<'alloc>),
    FunctionLikeParameter(&'a FunctionLikeParameter<'alloc>),
    FunctionLikeParameterDefaultValue(&'a FunctionLikeParameterDefaultValue<'alloc>),
    FunctionLikeParameterList(&'a FunctionLikeParameterList<'alloc>),
    FunctionLikeReturnTypeHint(&'a FunctionLikeReturnTypeHint<'alloc>),
    Global(&'a Global<'alloc>),
    Goto(&'a Goto),
    Label(&'a Label),
    ...
    Modifier(&'a Modifier),
    Namespace(&'a Namespace<'alloc>),
    NamespaceBody(&'a NamespaceBody<'alloc>),
    NamespaceImplicitBody(&'a NamespaceImplicitBody<'alloc>),
    Assignment(&'a Assignment<'alloc>),
    AssignmentOperator(&'a AssignmentOperator),
    Conditional(&'a Conditional<'alloc>),
    DoWhile(&'a DoWhile<'alloc>),
    Foreach(&'a Foreach<'alloc>),
    ForeachBody(&'a ForeachBody<'alloc>),
    ForeachColonDelimitedBody(&'a ForeachColonDelimitedBody<'alloc>),
    ForeachKeyValueTarget(&'a ForeachKeyValueTarget<'alloc>),
    ForeachTarget(&'a ForeachTarget<'alloc>),
    ForeachValueTarget(&'a ForeachValueTarget<'alloc>),
    For(&'a For<'alloc>),
    ForBody(&'a ForBody<'alloc>),
    ForColonDelimitedBody(&'a ForColonDelimitedBody<'alloc>),
    While(&'a While<'alloc>),
    WhileBody(&'a WhileBody<'alloc>),
    WhileColonDelimitedBody(&'a WhileColonDelimitedBody<'alloc>),
    Break(&'a Break<'alloc>),
    Continue(&'a Continue<'alloc>),
    Return(&'a Return<'alloc>),
    Static(&'a Static<'alloc>),
    StaticAbstractItem(&'a StaticAbstractItem),
    StaticConcreteItem(&'a StaticConcreteItem<'alloc>),
    StaticItem(&'a StaticItem<'alloc>),
    Try(&'a Try<'alloc>),
    TryCatchClause(&'a TryCatchClause<'alloc>),
    TryFinallyClause(&'a TryFinallyClause<'alloc>),
    MaybeTypedUseItem(&'a MaybeTypedUseItem),
    MixedUseItemList(&'a MixedUseItemList<'alloc>),
    TypedUseItemList(&'a TypedUseItemList<'alloc>),
    TypedUseItemSequence(&'a TypedUseItemSequence<'alloc>),
    Use(&'a Use<'alloc>),
    UseItem(&'a UseItem),
    UseItemAlias(&'a UseItemAlias),
    UseItemSequence(&'a UseItemSequence<'alloc>),
    UseItems(&'a UseItems<'alloc>),
    UseType(&'a UseType),
    Yield(&'a Yield<'alloc>),
    YieldFrom(&'a YieldFrom<'alloc>),
    YieldPair(&'a YieldPair<'alloc>),
    YieldValue(&'a YieldValue<'alloc>),
    Statement(&'a Statement<'alloc>),
    ExpressionStatement(&'a ExpressionStatement<'alloc>),
    BracedExpressionStringPart(&'a BracedExpressionStringPart<'alloc>),
    DocumentString(&'a DocumentString<'alloc>),
    InterpolatedString(&'a InterpolatedString<'alloc>),
    LiteralStringPart(&'a LiteralStringPart),
    ShellExecuteString(&'a ShellExecuteString<'alloc>),
    CompositeString(&'a CompositeString<'alloc>),
    StringPart(&'a StringPart<'alloc>),
    ...
    Throw(&'a Throw<'alloc>),
    Hint(&'a Hint<'alloc>),
    IntersectionHint(&'a IntersectionHint<'alloc>),
    NullableHint(&'a NullableHint<'alloc>),
    ParenthesizedHint(&'a ParenthesizedHint<'alloc>),
    UnionHint(&'a UnionHint<'alloc>),
    Unset(&'a Unset<'alloc>),
    DirectVariable(&'a DirectVariable),
    IndirectVariable(&'a IndirectVariable<'alloc>),
    NestedVariable(&'a NestedVariable<'alloc>),
    Variable(&'a Variable<'alloc>),
}
...
impl<'a, 'alloc> Node<'a, 'alloc> {
    ...
    #[inline]
    pub fn children(&self) -> Vec<Node<'a, 'alloc>> {
        match &self {
