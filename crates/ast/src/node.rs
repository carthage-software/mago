...
pub enum Node<'a> {
    ...
    UnaryPostfixOperation(&'a UnaryPostfixOperation),
...
impl<'a> Node<'a> {
    ...
    pub const fn kind(&self) -> NodeKind {
        match &self {
            ...
            Self::UnaryPostfixOperation(_) => NodeKind::UnaryPostfixOperation,
    ...
    pub fn children(&self) -> Vec<Node<'a>> {
        match &self {
            ...
            Node::UnaryPrefixOperation(node) => {
            ...
            Node::UnaryPostfixOperation(node) => {
...
impl<'a> HasSpan for Node<'a> {
    fn span(&self) -> Span {
        match self {
            ...
            Self::UnaryPostfixOperation(node) => node.span(),
