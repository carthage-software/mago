...
fn test_class_extends_addition() {
    let without = get_fingerprint(b"<?php class Child {}");
    let with = get_fingerprint(b"<?php class Child extends Parent {}");
...
fn test_class_extends_change() {
    let parent_a = get_fingerprint(b"<?php class Child extends ParentA {}");
    let parent_b = get_fingerprint(b"<?php class Child extends ParentB {}");
...
fn test_class_extends_with_namespace() {
    let without_ns = get_fingerprint(b"<?php class Child extends Parent {}");
    let with_ns = get_fingerprint(b"<?php class Child extends \\Namespace\\Parent {}");
...
fn test_class_extends_different_namespaces() {
    let ns1 = get_fingerprint(b"<?php class Child extends \\Ns1\\Parent {}");
    let ns2 = get_fingerprint(b"<?php class Child extends \\Ns2\\Parent {}");
...
fn test_class_extends_case_sensitivity() {
    let lower = get_fingerprint(b"<?php class Child extends parent {}");
    let upper = get_fingerprint(b"<?php class Child extends PARENT {}");
    let mixed = get_fingerprint(b"<?php class Child extends Parent {}");
...
fn test_class_implements_addition() {
    let without = get_fingerprint(b"<?php class A {}");
    let with = get_fingerprint(b"<?php class A implements I {}");
...
fn test_class_implements_multiple() {
    let one = get_fingerprint(b"<?php class A implements I1 {}");
    let two = get_fingerprint(b"<?php class A implements I1, I2 {}");
...
fn test_class_implements_order() {
    let order1 = get_fingerprint(b"<?php class A implements I1, I2 {}");
    let order2 = get_fingerprint(b"<?php class A implements I2, I1 {}");
...
fn test_class_implements_change() {
    let i1 = get_fingerprint(b"<?php class A implements I1 {}");
    let i2 = get_fingerprint(b"<?php class A implements I2 {}");
...
fn test_class_implements_namespaced() {
    let global = get_fingerprint(b"<?php class A implements I {}");
    let namespaced = get_fingerprint(b"<?php class A implements \\Ns\\I {}");
...
fn test_class_implements_three_interfaces() {
    let two = get_fingerprint(b"<?php class A implements I1, I2 {}");
    let three = get_fingerprint(b"<?php class A implements I1, I2, I3 {}");
...
fn test_class_implements_replacement() {
    let original = get_fingerprint(b"<?php class A implements I1, I2 {}");
    let replaced = get_fingerprint(b"<?php class A implements I3, I4 {}");
...
fn test_class_extends_and_implements() {
    let only_extends = get_fingerprint(b"<?php class A extends B {}");
    let both = get_fingerprint(b"<?php class A extends B implements I {}");
...
fn test_class_complex_hierarchy() {
    let simple = get_fingerprint(b"<?php class A {}");
    let complex = get_fingerprint(b"<?php class A extends B implements I1, I2, I3 {}");
...
fn test_class_hierarchy_change() {
    let hier1 = get_fingerprint(b"<?php class A extends B implements I1, I2 {}");
    let hier2 = get_fingerprint(b"<?php class A extends C implements I1, I3 {}");
...
fn test_interface_extends_addition() {
    let without = get_fingerprint(b"<?php interface I {}");
    let with = get_fingerprint(b"<?php interface I extends Base {}");
...
fn test_interface_extends_multiple() {
    let one = get_fingerprint(b"<?php interface I extends I1 {}");
    let two = get_fingerprint(b"<?php interface I extends I1, I2 {}");
...
fn test_interface_extends_change() {
    let i1 = get_fingerprint(b"<?php interface I extends I1 {}");
    let i2 = get_fingerprint(b"<?php interface I extends I2 {}");
...
fn test_interface_extends_order() {
    let order1 = get_fingerprint(b"<?php interface I extends I1, I2 {}");
    let order2 = get_fingerprint(b"<?php interface I extends I2, I1 {}");
...
fn test_interface_extends_namespaced() {
    let global = get_fingerprint(b"<?php interface I extends Base {}");
    let namespaced = get_fingerprint(b"<?php interface I extends \\Ns\\Base {}");
...
fn test_interface_multiple_parents() {
    let two = get_fingerprint(b"<?php interface I extends I1, I2 {}");
    let three = get_fingerprint(b"<?php interface I extends I1, I2, I3 {}");
...
fn test_trait_use_addition() {
    let without = get_fingerprint(b"<?php class A {}");
    let with = get_fingerprint(b"<?php class A { use T; }");
...
fn test_trait_use_multiple() {
    let one = get_fingerprint(b"<?php class A { use T1; }");
    let two = get_fingerprint(b"<?php class A { use T1, T2; }");
...
fn test_trait_use_order() {
    let order1 = get_fingerprint(b"<?php class A { use T1, T2; }");
    let order2 = get_fingerprint(b"<?php class A { use T2, T1; }");
...
fn test_trait_use_change() {
    let t1 = get_fingerprint(b"<?php class A { use T1; }");
    let t2 = get_fingerprint(b"<?php class A { use T2; }");
...
fn test_trait_use_aliasing() {
    let without_alias = get_fingerprint(b"<?php class A { use T; }");
    let with_alias = get_fingerprint(b"<?php class A { use T { foo as bar; } }");
...
fn test_trait_use_multiple_aliases() {
    let one_alias = get_fingerprint(b"<?php class A { use T { foo as bar; } }");
    let two_aliases = get_fingerprint(b"<?php class A { use T { foo as bar; baz as qux; } }");
...
fn test_trait_use_insteadof() {
    let without = get_fingerprint(b"<?php class A { use T1, T2; }");
    let with = get_fingerprint(b"<?php class A { use T1, T2 { T1::foo insteadof T2; } }");
...
fn test_trait_use_visibility_change() {
    let without = get_fingerprint(b"<?php class A { use T; }");
    let with_private = get_fingerprint(b"<?php class A { use T { foo as private; } }");
    let with_public = get_fingerprint(b"<?php class A { use T { foo as public; } }");
...
fn test_trait_use_combined_adaptations() {
    let simple = get_fingerprint(b"<?php class A { use T; }");
    let complex = get_fingerprint(b"<?php class A { use T { foo as private bar; baz as public; } }");
...
fn test_trait_use_namespaced() {
    let global = get_fingerprint(b"<?php class A { use T; }");
    let namespaced = get_fingerprint(b"<?php class A { use \\Ns\\T; }");
...
fn test_trait_in_trait() {
    let without = get_fingerprint(b"<?php trait T1 {}");
    let with = get_fingerprint(b"<?php trait T1 { use T2; }");
...
fn test_enum_case_addition() {
    let one = get_fingerprint(b"<?php enum E { case A; }");
    let two = get_fingerprint(b"<?php enum E { case A; case B; }");
...
fn test_enum_case_name_change() {
    let case_a = get_fingerprint(b"<?php enum E { case A; }");
    let case_b = get_fingerprint(b"<?php enum E { case B; }");
...
fn test_enum_case_order() {
    let order1 = get_fingerprint(b"<?php enum E { case A; case B; }");
    let order2 = get_fingerprint(b"<?php enum E { case B; case A; }");
...
fn test_enum_backed_type_addition() {
    let pure = get_fingerprint(b"<?php enum E { case A; }");
    let backed = get_fingerprint(b"<?php enum E: string { case A = 'a'; }");
...
fn test_enum_backed_type_change() {
    let string_backed = get_fingerprint(b"<?php enum E: string { case A = 'a'; }");
    let int_backed = get_fingerprint(b"<?php enum E: int { case A = 1; }");
...
fn test_enum_backed_value_change() {
    let value_a = get_fingerprint(b"<?php enum E: string { case A = 'a'; }");
    let value_b = get_fingerprint(b"<?php enum E: string { case A = 'b'; }");
...
fn test_enum_multiple_backed_cases() {
    let one = get_fingerprint(b"<?php enum E: int { case A = 1; }");
    let two = get_fingerprint(b"<?php enum E: int { case A = 1; case B = 2; }");
...
fn test_enum_implements() {
    let without = get_fingerprint(b"<?php enum E {}");
    let with = get_fingerprint(b"<?php enum E implements I {}");
...
fn test_enum_implements_multiple() {
    let one = get_fingerprint(b"<?php enum E implements I1 {}");
    let two = get_fingerprint(b"<?php enum E implements I1, I2 {}");
...
fn test_enum_with_methods() {
    let without = get_fingerprint(b"<?php enum E { case A; }");
    let with = get_fingerprint(b"<?php enum E { case A; public function foo() {} }");
...
fn test_enum_backed_mixed_values() {
    let sequential = get_fingerprint(b"<?php enum E: int { case A = 0; case B = 1; }");
    let non_sequential = get_fingerprint(b"<?php enum E: int { case A = 10; case B = 20; }");
...
fn test_constructor_property_promotion() {
    let regular = get_fingerprint(b"<?php class A { public function __construct($x) {} }");
    let promoted = get_fingerprint(b"<?php class A { public function __construct(public $x) {} }");
...
fn test_constructor_property_promotion_type() {
    let without_type = get_fingerprint(b"<?php class A { public function __construct(public $x) {} }");
    let with_type = get_fingerprint(b"<?php class A { public function __construct(public int $x) {} }");
...
fn test_constructor_property_promotion_readonly() {
    let regular = get_fingerprint(b"<?php class A { public function __construct(public $x) {} }");
    let readonly = get_fingerprint(b"<?php class A { public function __construct(public readonly $x) {} }");
...
fn test_constructor_mixed_params() {
    let all_regular = get_fingerprint(b"<?php class A { public function __construct($x, $y) {} }");
    let one_promoted = get_fingerprint(b"<?php class A { public function __construct(public $x, $y) {} }");
    let both_promoted = get_fingerprint(b"<?php class A { public function __construct(public $x, public $y) {} }");
...
fn test_constructor_promotion_visibility() {
    let public = get_fingerprint(b"<?php class A { public function __construct(public $x) {} }");
    let private = get_fingerprint(b"<?php class A { public function __construct(private $x) {} }");
    let protected = get_fingerprint(b"<?php class A { public function __construct(protected $x) {} }");
...
fn test_constructor_promotion_with_defaults() {
    let without_default = get_fingerprint(b"<?php class A { public function __construct(public int $x) {} }");
    let with_default = get_fingerprint(b"<?php class A { public function __construct(public int $x = 0) {} }");
...
fn test_class_attribute_addition() {
    let without = get_fingerprint(b"<?php class A {}");
    let with = get_fingerprint(b"<?php #[Attribute] class A {}");
...
fn test_method_attribute_addition() {
    let without = get_fingerprint(b"<?php class A { function foo() {} }");
    let with = get_fingerprint(b"<?php class A { #[Route] function foo() {} }");
...
fn test_property_attribute_addition() {
    let without = get_fingerprint(b"<?php class A { public $x; }");
    let with = get_fingerprint(b"<?php class A { #[Required] public $x; }");
...
fn test_parameter_attribute_addition() {
    let without = get_fingerprint(b"<?php function foo($x) {}");
    let with = get_fingerprint(b"<?php function foo(#[Inject] $x) {}");
...
fn test_attribute_argument_change() {
    let arg1 = get_fingerprint(b"<?php #[Route('/path1')] class A {}");
    let arg2 = get_fingerprint(b"<?php #[Route('/path2')] class A {}");
...
fn test_multiple_attributes_same_target() {
    let one = get_fingerprint(b"<?php #[Attr1] class A {}");
    let two = get_fingerprint(b"<?php #[Attr1] #[Attr2] class A {}");
...
fn test_attribute_order() {
    let order1 = get_fingerprint(b"<?php #[Attr1] #[Attr2] class A {}");
    let order2 = get_fingerprint(b"<?php #[Attr2] #[Attr1] class A {}");
...
fn test_attribute_on_enum_case() {
    let without = get_fingerprint(b"<?php enum E { case A; }");
    let with = get_fingerprint(b"<?php enum E { #[Label('A')] case A; }");
...
fn test_anonymous_class_extends() {
    let without = get_fingerprint(b"<?php $x = new class {};");
    let with = get_fingerprint(b"<?php $x = new class extends Parent {};");
...
fn test_anonymous_class_implements() {
    let without = get_fingerprint(b"<?php $x = new class {};");
    let with = get_fingerprint(b"<?php $x = new class implements I {};");
...
fn test_anonymous_class_uses_trait() {
    let without = get_fingerprint(b"<?php $x = new class {};");
    let with = get_fingerprint(b"<?php $x = new class { use T; };");
...
fn test_anonymous_class_full_hierarchy() {
    ...
    let complex = get_fingerprint(b"<?php $x = new class extends Base implements I1, I2 { use T; };");
