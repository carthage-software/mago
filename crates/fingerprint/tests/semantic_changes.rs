...
fn test_method_name_change() {
    let foo = get_fingerprint(b"<?php class A { function foo() {} }");
    let bar = get_fingerprint(b"<?php class A { function bar() {} }");
...
fn test_property_name_change() {
    let foo = get_fingerprint(b"<?php class A { public $foo; }");
    let bar = get_fingerprint(b"<?php class A { public $bar; }");
...
fn test_parameter_addition() {
    let no_param = get_fingerprint(b"<?php function foo() {}");
    let with_param = get_fingerprint(b"<?php function foo($x) {}");
...
fn test_parameter_name_change() {
    let x = get_fingerprint(b"<?php function foo($x) {}");
    let y = get_fingerprint(b"<?php function foo($y) {}");
...
fn test_return_type_addition() {
    ...
    let with_type = get_fingerprint(b"<?php function foo(): int {}");
...
fn test_return_type_change() {
    let int_type = get_fingerprint(b"<?php function foo(): int {}");
    let string_type = get_fingerprint(b"<?php function foo(): string {}");
...
fn test_abstract_modifier_addition() {
    let concrete = get_fingerprint(b"<?php class A { public function foo() {} }");
...
fn test_class_extends_addition() {
    let no_extends = get_fingerprint(b"<?php class Foo {}");
    let with_extends = get_fingerprint(b"<?php class Foo extends Bar {}");
...
fn test_class_implements_addition() {
    let no_implements = get_fingerprint(b"<?php class Foo {}");
    let with_implements = get_fingerprint(b"<?php class Foo implements Bar {}");
...
fn test_interface_extends_addition() {
    let no_extends = get_fingerprint(b"<?php interface Foo {}");
    let with_extends = get_fingerprint(b"<?php interface Foo extends Bar {}");
...
fn test_use_trait_addition() {
    let no_trait = get_fingerprint(b"<?php class Foo {}");
    let with_trait = get_fingerprint(b"<?php class Foo { use Bar; }");
...
fn test_constant_value_change() {
    let value_1 = get_fingerprint(b"<?php const X = 1;");
    let value_2 = get_fingerprint(b"<?php const X = 2;");
...
fn test_enum_case_addition() {
    let one_case = get_fingerprint(b"<?php enum Status { case Active; }");
    let two_cases = get_fingerprint(b"<?php enum Status { case Active; case Inactive; }");
...
fn test_enum_backed_type_change() {
    let string_backed = get_fingerprint(b"<?php enum Status: string { case Active = 'active'; }");
    let int_backed = get_fingerprint(b"<?php enum Status: int { case Active = 1; }");
...
fn test_nullable_type_addition() {
    let not_null = get_fingerprint(b"<?php function foo(string $x) {}");
    let nullable = get_fingerprint(b"<?php function foo(?string $x) {}");
...
fn test_union_type_addition() {
    let single = get_fingerprint(b"<?php function foo(string $x) {}");
    let union = get_fingerprint(b"<?php function foo(string|int $x) {}");
...
fn test_intersection_type() {
    let single = get_fingerprint(b"<?php function foo(A $x) {}");
    let intersection = get_fingerprint(b"<?php function foo(A&B $x) {}");
...
fn test_function_body_changes() {
    let body1 = get_fingerprint(b"<?php function foo() { return 1; }");
    let body2 = get_fingerprint(b"<?php function foo() { return 2; }");
...
fn test_adding_statement_to_body() {
    let one_stmt = get_fingerprint(b"<?php function foo() { $x = 1; }");
    let two_stmts = get_fingerprint(b"<?php function foo() { $x = 1; $y = 2; }");
...
fn test_reordering_statements() {
    let order1 = get_fingerprint(b"<?php function foo() { $x = 1; $y = 2; }");
    let order2 = get_fingerprint(b"<?php function foo() { $y = 2; $x = 1; }");
...
fn test_changing_variable_names_in_body() {
    let var_x = get_fingerprint(b"<?php function foo() { $x = 1; }");
    let var_y = get_fingerprint(b"<?php function foo() { $y = 1; }");
...
fn test_operator_change() {
    let addition = get_fingerprint(b"<?php $x = $a + $b;");
    let subtraction = get_fingerprint(b"<?php $x = $a - $b;");
...
fn test_literal_value_change() {
    let value_1 = get_fingerprint(b"<?php $x = 1;");
    let value_2 = get_fingerprint(b"<?php $x = 2;");
...
fn test_string_content_change() {
    let str1 = get_fingerprint(b"<?php $x = 'hello';");
    let str2 = get_fingerprint(b"<?php $x = 'world';");
...
fn test_array_element_addition() {
    let one = get_fingerprint(b"<?php $x = [1];");
    let two = get_fingerprint(b"<?php $x = [1, 2];");
...
fn test_readonly_property_addition() {
    let regular = get_fingerprint(b"<?php class A { public string $x; }");
...
fn test_readonly_class() {
    let regular = get_fingerprint(b"<?php class A {}");
    let readonly = get_fingerprint(b"<?php readonly class A {}");
...
fn test_parameter_default_value_addition() {
    ...
    let with = get_fingerprint(b"<?php function foo($x = 1) {}");
...
fn test_parameter_default_value_change() {
    let default_1 = get_fingerprint(b"<?php function foo($x = 1) {}");
    let default_2 = get_fingerprint(b"<?php function foo($x = 2) {}");
...
fn test_property_default_value() {
    ...
    let with = get_fingerprint(b"<?php class A { public $x = 1; }");
...
fn test_combined_changes() {
    let original = get_fingerprint(b"<?php class Foo { public function bar() {} }");
    let modified = get_fingerprint(b"<?php abstract class Foo { abstract public static function bar(): int; }");
...
fn test_cosmetic_vs_semantic() {
    let code = b"<?php class Foo { public function bar(): int { return 1; } }";
    let whitespace_changed =
        b"<?php\n\nclass   Foo\n{\n    public    function   bar()  :  int\n    {\n        return   1;\n    }\n}";
    let semantic_changed = b"<?php class Foo { public function bar(): string { return '1'; } }";
