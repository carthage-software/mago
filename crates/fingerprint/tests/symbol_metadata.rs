...
fn test_class_attribute_addition() {
    ...
    let with = get_fingerprint(b"<?php #[Attribute] class Foo {}");
...
fn test_class_attribute_change() {
    let attr1 = get_fingerprint(b"<?php #[Attribute1] class Foo {}");
    let attr2 = get_fingerprint(b"<?php #[Attribute2] class Foo {}");
...
fn test_class_multiple_attributes() {
    let one = get_fingerprint(b"<?php #[Attr1] class Foo {}");
    let two = get_fingerprint(b"<?php #[Attr1] #[Attr2] class Foo {}");
...
fn test_class_attribute_order() {
    let order1 = get_fingerprint(b"<?php #[Attr1] #[Attr2] class Foo {}");
    let order2 = get_fingerprint(b"<?php #[Attr2] #[Attr1] class Foo {}");
...
fn test_class_attribute_with_arguments() {
    let without_args = get_fingerprint(b"<?php #[Route] class Foo {}");
    let with_args = get_fingerprint(b"<?php #[Route('/path')] class Foo {}");
...
fn test_class_attribute_argument_change() {
    let arg1 = get_fingerprint(b"<?php #[Route('/path1')] class Foo {}");
    let arg2 = get_fingerprint(b"<?php #[Route('/path2')] class Foo {}");
...
fn test_class_attribute_multiple_arguments() {
    let one_arg = get_fingerprint(b"<?php #[Route('/path')] class Foo {}");
    let two_args = get_fingerprint(b"<?php #[Route('/path', 'GET')] class Foo {}");
...
fn test_method_attribute_change() {
    let attr1 = get_fingerprint(b"<?php class A { #[Get] function foo() {} }");
    let attr2 = get_fingerprint(b"<?php class A { #[Post] function foo() {} }");
...
fn test_method_multiple_attributes() {
    let one = get_fingerprint(b"<?php class A { #[Route('/path')] function foo() {} }");
    let two = get_fingerprint(b"<?php class A { #[Route('/path')] #[Auth] function foo() {} }");
...
fn test_method_attribute_with_named_args() {
    let positional = get_fingerprint(b"<?php class A { #[Route('/path', 'GET')] function foo() {} }");
    let named = get_fingerprint(b"<?php class A { #[Route(path: '/path', method: 'GET')] function foo() {} }");
...
fn test_property_attribute_change() {
    let attr1 = get_fingerprint(b"<?php class A { #[Min(1)] public $x; }");
    let attr2 = get_fingerprint(b"<?php class A { #[Max(100)] public $x; }");
...
fn test_property_multiple_attributes() {
    let one = get_fingerprint(b"<?php class A { #[Required] public $x; }");
    let two = get_fingerprint(b"<?php class A { #[Required] #[Email] public $x; }");
...
fn test_parameter_attribute_change() {
    let attr1 = get_fingerprint(b"<?php function foo(#[Inject] $x) {}");
    let attr2 = get_fingerprint(b"<?php function foo(#[Autowire] $x) {}");
...
fn test_parameter_multiple_attributes() {
    let one = get_fingerprint(b"<?php function foo(#[Inject] $x) {}");
    let two = get_fingerprint(b"<?php function foo(#[Inject] #[Required] $x) {}");
...
fn test_different_parameter_attributes() {
    let first = get_fingerprint(b"<?php function foo(#[Inject] $x, $y) {}");
    let second = get_fingerprint(b"<?php function foo($x, #[Inject] $y) {}");
...
fn test_enum_case_attribute() {
    let without = get_fingerprint(b"<?php enum Status { case Active; }");
    let with = get_fingerprint(b"<?php enum Status { #[Label('Active')] case Active; }");
...
fn test_enum_case_attribute_different_cases() {
    let first = get_fingerprint(b"<?php enum Status { #[Label('A')] case Active; case Inactive; }");
    let second = get_fingerprint(b"<?php enum Status { case Active; #[Label('I')] case Inactive; }");
...
fn test_class_abstract_modifier() {
    let concrete = get_fingerprint(b"<?php class Foo {}");
    let abstract_class = get_fingerprint(b"<?php abstract class Foo {}");
...
fn test_class_final_modifier() {
    let regular = get_fingerprint(b"<?php class Foo {}");
    let final_class = get_fingerprint(b"<?php final class Foo {}");
...
fn test_class_readonly_modifier() {
    let regular = get_fingerprint(b"<?php class Foo {}");
    let readonly = get_fingerprint(b"<?php readonly class Foo {}");
...
fn test_method_visibility_public() {
    let implicit = get_fingerprint(b"<?php class A { function foo() {} }");
    let explicit = get_fingerprint(b"<?php class A { public function foo() {} }");
...
fn test_method_visibility_private() {
    let public_method = get_fingerprint(b"<?php class A { public function foo() {} }");
    let private_method = get_fingerprint(b"<?php class A { private function foo() {} }");
...
fn test_method_visibility_protected() {
    let public_method = get_fingerprint(b"<?php class A { public function foo() {} }");
    let protected_method = get_fingerprint(b"<?php class A { protected function foo() {} }");
...
fn test_method_static_modifier() {
    let instance = get_fingerprint(b"<?php class A { public function foo() {} }");
    let static_method = get_fingerprint(b"<?php class A { public static function foo() {} }");
...
fn test_method_abstract_modifier() {
    let concrete = get_fingerprint(b"<?php abstract class A { public function foo() {} }");
    let abstract_method = get_fingerprint(b"<?php abstract class A { abstract public function foo(); }");
...
fn test_method_final_modifier() {
    let regular = get_fingerprint(b"<?php class A { public function foo() {} }");
    let final_method = get_fingerprint(b"<?php class A { final public function foo() {} }");
...
fn test_property_visibility_public() {
    let public_prop = get_fingerprint(b"<?php class A { public $x; }");
    let private_prop = get_fingerprint(b"<?php class A { private $x; }");
...
fn test_property_static_modifier() {
    let instance = get_fingerprint(b"<?php class A { public $x; }");
    let static_prop = get_fingerprint(b"<?php class A { public static $x; }");
...
fn test_property_readonly_modifier() {
    let mutable = get_fingerprint(b"<?php class A { public string $x; }");
    let readonly = get_fingerprint(b"<?php class A { public readonly string $x; }");
...
fn test_method_multiple_modifiers() {
    let simple = get_fingerprint(b"<?php class A { function foo() {} }");
    let complex = get_fingerprint(b"<?php class A { final public static function foo() {} }");
...
fn test_property_multiple_modifiers() {
    let simple = get_fingerprint(b"<?php class A { $x; }");
    let complex = get_fingerprint(b"<?php class A { private static readonly int $x; }");
...
fn test_class_constant_visibility() {
    let public_const = get_fingerprint(b"<?php class A { const X = 1; }");
    let private_const = get_fingerprint(b"<?php class A { private const X = 1; }");
...
fn test_class_constant_final() {
    let regular = get_fingerprint(b"<?php class A { const X = 1; }");
    let final_const = get_fingerprint(b"<?php class A { final const X = 1; }");
...
fn test_nested_attribute_arguments() {
    let simple = get_fingerprint(b"<?php #[Route('/path')] class Foo {}");
    let nested = get_fingerprint(b"<?php #[Route('/path', options: ['auth' => true])] class Foo {}");
...
fn test_attribute_with_class_constant() {
    let literal = get_fingerprint(b"<?php #[Route('/path')] class Foo {}");
    let constant = get_fingerprint(b"<?php #[Route(MyClass::PATH)] class Foo {}");
...
fn test_attribute_with_array() {
    let without = get_fingerprint(b"<?php #[Middleware] class Foo {}");
    let with_array = get_fingerprint(b"<?php #[Middleware(['auth', 'csrf'])] class Foo {}");
...
fn test_same_attribute_different_targets() {
    let on_class = get_fingerprint(b"<?php #[Inject] class Foo { public $x; }");
    let on_property = get_fingerprint(b"<?php class Foo { #[Inject] public $x; }");
...
fn test_attribute_on_promoted_property() {
    ...
    let with_attr = get_fingerprint(b"<?php class A { public function __construct(#[Inject] public $x) {} }");
...
fn test_all_method_visibility_options() {
    let public = get_fingerprint(b"<?php class A { public function foo() {} }");
    let protected = get_fingerprint(b"<?php class A { protected function foo() {} }");
    let private = get_fingerprint(b"<?php class A { private function foo() {} }");
...
fn test_all_property_visibility_options() {
    let public = get_fingerprint(b"<?php class A { public $x; }");
    let protected = get_fingerprint(b"<?php class A { protected $x; }");
    let private = get_fingerprint(b"<?php class A { private $x; }");
...
fn test_modifier_order_normalization() {
    let order1 = get_fingerprint(b"<?php class A { public static function foo() {} }");
    let order2 = get_fingerprint(b"<?php class A { static public function foo() {} }");
...
fn test_final_public_vs_public_final() {
    let order1 = get_fingerprint(b"<?php class A { final public function foo() {} }");
    let order2 = get_fingerprint(b"<?php class A { public final function foo() {} }");
...
fn test_class_with_all_metadata() {
    let minimal = get_fingerprint(b"<?php class Foo {}");
...
fn test_method_with_all_metadata() {
    let minimal = get_fingerprint(b"<?php class A { function foo() {} }");
    let maximal = get_fingerprint(
        b"<?php
        class A {
            #[Route('/path')]
...
fn test_property_with_all_metadata() {
    let minimal = get_fingerprint(b"<?php class A { $x; }");
    let maximal = get_fingerprint(
        b"<?php
        class A {
            #[Required]
...
fn test_interface_with_attributes() {
    let without = get_fingerprint(b"<?php interface Repository {}");
    let with = get_fingerprint(b"<?php #[InterfaceType] interface Repository {}");
...
fn test_trait_with_attributes() {
    let without = get_fingerprint(b"<?php trait Timestampable {}");
    let with = get_fingerprint(b"<?php #[TraitType] trait Timestampable {}");
...
fn test_enum_with_attributes() {
    let without = get_fingerprint(b"<?php enum Status {}");
    let with = get_fingerprint(b"<?php #[EnumType] enum Status {}");
...
fn test_enum_implements_with_attributes() {
    let without = get_fingerprint(b"<?php enum Status implements Stringable {}");
    let with = get_fingerprint(b"<?php #[JsonSerializable] enum Status implements Stringable {}");
