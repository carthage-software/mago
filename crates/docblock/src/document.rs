    ...
    T: AsRef<str>,
{
    fn from(value: T) -> Self {
        match value.as_ref().to_ascii_lowercase().as_str() {
            ...
            "experimental" => TagKind::Experimental,
            ...
            "inheritdoc" | "inheritdocs" | "inherit-doc" | "inherit-docs" => TagKind::InheritDoc,
            ...
            "suspends-fiber" | "suspendsfiber" => TagKind::SuspendsFiber,
            ...
            "type" => TagKind::Type,
            "phpstan-type" | "phpstantype" => TagKind::PhpstanType,
            "psalm-type" | "psalmtype" => TagKind::PsalmType,
            "import-type" | "importtype" => TagKind::ImportType,
            "phpstan-import-type" | "phpstanimporttype" => TagKind::PhpstanImportType,
