...
#[test]
fn anonymous_var_overrides_assigned_value() {
    assert_eq!(ty(b"<?php $x = `ls`; $x;"), "false|null|string");
    assert_eq!(ty(b"<?php /** @var string */ $x = `ls`; $x;"), "string");
    assert_eq!(ty(b"<?php /** @var int */ $x = 'hello'; $x;"), "int");
    assert_eq!(ty(b"<?php /** @var non-empty-string */ $x = 1; $x;"), "non-empty-string");
}

#[test]
fn named_var_pins_the_target_variable() {
    assert_eq!(ty(b"<?php /** @var string $bar */ $bar = 1; $bar;"), "string");
}

#[test]
fn annotated_assignment_evaluates_to_annotated_type() {
    assert_eq!(ty(b"<?php /** @var string */ $b = 1;"), "string");
    assert_eq!(ty(b"<?php /** @var string $b */ $b = 1;"), "string");
    assert_eq!(ty(b"<?php /** @var string $b */ $b = 1; $c = $b; $c;"), "string");
}
