...
pub fn reflect_function<'i, 'ast>(function: &'ast Function, context: &'ast mut Context<'i>) -> FunctionLikeReflection {
    FunctionLikeReflection {
        attribute_reflections: reflect_attributes(&function.attributes, context),
        identifier: FunctionLikeIdentifier::Function(context.semantics.names.get(&function.name), function.name.span),
        parameter_reflections: reflect_function_like_parameter_list(&function.parameters, context),
        return_type_reflection: reflect_function_like_return_type_hint(&function.return_type_hint, context),
...
pub fn reflect_closure<'i, 'ast>(closure: &'ast Closure, context: &'ast mut Context<'i>) -> FunctionLikeReflection {
    FunctionLikeReflection {
        attribute_reflections: reflect_attributes(&closure.attributes, context),
        identifier: FunctionLikeIdentifier::Closure(closure.span()),
        parameter_reflections: reflect_function_like_parameter_list(&closure.parameters, context),
        return_type_reflection: reflect_function_like_return_type_hint(&closure.return_type_hint, context),
...
pub fn reflect_arrow_function<'i, 'ast>(
    ...
    FunctionLikeReflection {
        ...
        identifier: FunctionLikeIdentifier::ArrowFunction(arrow_function.span()),
        parameter_reflections: reflect_function_like_parameter_list(&arrow_function.parameters, context),
        return_type_reflection: reflect_function_like_return_type_hint(&arrow_function.return_type_hint, context),
...
pub fn reflect_function_like_parameter_list<'i, 'ast>(
    ...
    for parameter in parameter_list.parameters.iter() {
        parameters.push(reflect_function_like_parameter(parameter, context));
    }
...
pub fn reflect_function_like_parameter<'i, 'ast>(
    ...
    FunctionLikeParameterReflection {
        ...
        type_reflection: maybe_reflect_hint(&parameter.hint, context),
...
pub fn reflect_function_like_return_type_hint<'i, 'ast>(
    ...
    Some(FunctionLikeReturnTypeReflection {
        type_reflection: reflect_hint(&return_type_hint.hint, context),
