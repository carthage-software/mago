...
pub struct Interface<'arena, I, S, E> {
    pub span: Span,
...
impl<I, S, E> CopyInto for Interface<'_, I, S, E>
where
    I: CopyInto,
    S: CopyInto,
    E: CopyInto,
{
    type Output<'arena> = Interface<'arena, I::Output<'arena>, S::Output<'arena>, E::Output<'arena>>;
...
impl<'arena, I, S, E> Item<'arena, I, S, E> for Interface<'arena, I, S, E> {
...
impl<I, S, E> HasSpan for Interface<'_, I, S, E> {
    fn span(&self) -> Span {
        self.span
    }
}
